...
export const ru: Translation = {
  ...
  login: {
    ...
    errorSessionRejected:
      'Вход выполнен, но браузер не принял сессию. Проверьте дату, время и часовой пояс на этом компьютере и попробуйте снова.',
    clockSkewWarning:
      'Часы этого компьютера расходятся с сервером примерно на {{minutes}} мин. Исправьте, если возможно — часть экранов на них опирается.',
  },
  dashboard: {
